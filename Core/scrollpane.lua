function dgsCreateScrollPane(x,y,sx,sy,relative,parent)
	...
	local scrollbar1 = dgsCreateScrollBar(x+sx-scrbThick,y-titleOffset,scrbThick,sy,false,false,parent)
	local scrollbar2 = dgsCreateScrollBar(x,y+sy-scrbThick-titleOffset,sx,scrbThick,true,false,parent)
